...
$sql = "INSERT into userdetail (p_id,name,email,password,phone_number) VALUES ('$adhar','$name','$email','$pass','$phone')";
if(!mysqli_query($conn,$sql)){
  echo "<script>alert('enter correctly or you have already account');</script>";
  }
  else
